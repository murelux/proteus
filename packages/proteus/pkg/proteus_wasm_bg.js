 ...
 * @returns {any}
 */
export function extract_markdown_ast(markdown) {
    const ptr0 = passStringToWasm0(markdown, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.extract_markdown_ast(ptr0, len0);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function parse_toml(input) {
    const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
 ...
 * @returns {any}
 */
export function parse_yaml(input) {
    const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
...
export function stringify_json(value) {
    ...
    let deferred2_1;
    try {
        const ret = wasm.stringify_json(value);
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @returns {string}
 */
export function stringify_toml(value) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.stringify_toml(value);
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
 ...
 * @returns {string}
 */
export function stringify_yaml(value) {
    let deferred2_0;
    let deferred2_1;
    try {
        const ret = wasm.stringify_yaml(value);
        var ptr1 = ret[0];
        var len1 = ret[1];
        if (ret[3]) {
            ptr1 = 0; len1 = 0;
